...
with open("data/Drained_dense_history.json", "r") as file:
...
fig = make_subplots(
    ...
    specs=[[{"rowspan": 3}, {}],
           [     None,      {}],
           [     None,      {}]],
    subplot_titles=("Drained Dense: Stress Path, Yield Surface, and Image Point", "", "", "")
)
...
fig.write_html("Drained_Dense.html")